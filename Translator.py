...
def on_leavebtn2(e):
 ...
 ################################################################# comboBox languages
languages = StringVar()
font_box = Combobox(root,width=33,textvariable=languages,state='readonly')
...
############################################################## Buttons
imgbt1 = imgbt1 = PhotoImage(file='touch.png')
imgbt2 = imgbt2 = PhotoImage(file='logout.png')

imgbt1 = imgbt1.subsample(14,15)
imgbt2 = imgbt2.subsample(14,15)


btn1 = Button(root,text='Click',bd=10,bg='yellow',activebackground='red',width=50,font=('times',15,'italic bold'),
              image=imgbt1,compound=RIGHT,command=tt)
btn1.place(x=70,y=170)

btn2 = Button(root,text='Exit',bd=10,bg='yellow',activebackground='red',width=50,font=('times',15,'italic bold'),
